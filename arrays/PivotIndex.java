...
public class PivotIndex {
    ...
    public static int pivotIndex(int[] nums) {
        ...
        // 1,7,3,6,5,6
        // left sum at current index = totalSum - rightSum - current index element
        // right sum at current index = totalSum -  leftSum - current index element
        ...
        int leftSumIncludingCurrentIndex = 0;
        for (int i = 0; i < nums.length; i++) {
            leftSumIncludingCurrentIndex += nums[i];

            leftSum = leftSumIncludingCurrentIndex - nums[i];
            rightSum = totalSum - leftSumIncludingCurrentIndex;
